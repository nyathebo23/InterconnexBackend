...
class AgentsControlsActionsTest(APITestCase):
    ...
    def setUp(self) -> None:
        self.user_init = User.objects.create_user(username="Nyat", email="franckhebo@gmail.com", password="Franck23.", role="Agent source", sex="male")
        ...
        localinf = LocalInformer.objects.create(name="SEGC")
        aerodrome = Aerodrome.objects.create(name="Aeroport de Douala", code="KKKG", location_ind="KG", local_informer=localinf) 
        aerodrome2 = Aerodrome.objects.create(name="Aeroport de Yaoundé", code="KKKB", location_ind="KB", local_informer=localinf) 
        ...
        unit = Unit.objects.create(email="doualaaero@gmail.com", name="AIM", phone_number="+26556566", fax="256656", address="azertgyh", aerodrome=aerodrome) 
        unit2 = Unit.objects.create(email="yaoundeaero@gmail.com", name="AIM", phone_number="+26556566", fax="256656", address="azertgyh", aerodrome=aerodrome2) 
    ...
    def test_failed_controls_on_ddia(self):
        urlcreate = reverse('notam-create')
        data_notam = {
            'start_val_period': datetime.date(2021, 2, 22),
            'end_val_period': datetime.date(2021, 1, 22),
            'daily_freq_start': datetime.time(18, 30),
            'daily_freq_end': datetime.time(17, 30),
            'attachments': []
        }
        self.client = APIClient()
        ...
        self.assertEqual(resp.status_code, status.HTTP_403_FORBIDDEN, "notam submit error")
